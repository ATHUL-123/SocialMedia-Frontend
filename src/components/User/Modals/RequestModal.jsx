...
function RequestModal({ isOpen, closeModal, loading, request, setRequestCount, setRequests }) {
            ...
            <div className="mt-5 text-center">
              ...
              <div className="max-h-60 overflow-y-auto hide-scrollbar">
                <ul className="text-gray-500 dark:text-gray-400 text-left">
                  {request.map(user => (
                    <RequestList setRequests={setRequests} setRequestCount={setRequestCount} key={user._id} user={user} />
                  ))}
                </ul>
              </div>
