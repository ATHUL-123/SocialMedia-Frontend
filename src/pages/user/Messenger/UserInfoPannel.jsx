...
const UserInfoPanel = ({currChat,toggleSidebar}) => {
  ...
  return (
    ...
    <nav className="right-0 flex flex-col hidden pb-2 bg-white border-l border-gray-300 xl:block" style={{ width: '24rem', marginTop: '4rem', overflowY: 'hidden' } }>
      <div className="flex items-center justify-between w-full p-3">
        <button onClick={handleClose} className="p-2 text-gray-500 rounded-full focus:outline-none hover:text-gray-600 hover:bg-gray-200">
      ...
      <div>
        <div className="flex justify-center mb-4">
          <button type="button" className="content-center block w-32 h-32 p-1 overflow-hidden text-center rounded-full focus:outline-none">
            <img className="content-center object-cover w-full h-full border-2 border-gray-200 rounded-full" src={convUser.profilePic} alt="" />
          </button>
        </div>
      ...
      <div className="flex items-center w-full px-3 mt-6">
        ...
        <div className="ml-4">
          <div className="mr-auto text-sm font-semibold text-gray-800">{convUser.bio}</div>
      ...
      <div>
        <div className="flex items-center w-full px-3 mt-4">
          ...
          <div className="ml-4">
            <div className="mr-auto text-sm font-semibold text-gray-800">+91 {convUser.phone}</div>
      ...
      <ul className="flex flex-row items-center justify-around px-3 mb-1 list-none border-b select-none">
        ...
        <li className="flex-auto px-4 mx-1 -mb-px text-center rounded-t-lg cursor-pointer last:mr-0 hover:bg-gray-200">
          <a href="#_" className="block py-3 text-gray-600">Docs</a>
        </li>
        <li className="flex-auto px-4 mx-1 -mb-px text-center rounded-t-lg cursor-pointer last:mr-0 hover:bg-gray-200">
          <a href="#_" className="block py-3 text-gray-600">Links</a>
        </li>
        <li className="flex-auto px-4 mx-1 -mb-px text-center rounded-t-lg cursor-pointer last:mr-0 hover:bg-gray-200">
